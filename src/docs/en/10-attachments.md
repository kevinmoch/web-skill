...
![Multiple attachment chips in the input field, each with a type label](/docs-assets/attachments/zh/S-attachments-01-chips.png)

An attachment chip shows the file name, size, and type label; you can remove it any time before sending.

![An input field with an xlsx attached, the type label showing "Doc text"](/docs-assets/attachments/zh/S-attachments-07-xlsx-doc-text.png)
...
![M-10 The path of a file into the conversation](/docs-assets/attachments/M-10.svg)
...
![The compression notice "Compressed …" on an attachment chip](/docs-assets/attachments/zh/S-attachments-02-compressed.png)
...
![The over-limit notice, listing the file names that weren't sent](/docs-assets/attachments/zh/S-attachments-08-images-dropped.png)
...
![Voice input recording, the button now reading "Stop voice input"](/docs-assets/attachments/zh/S-attachments-03-dictating.png)
...
![The camera dialog: the viewfinder view and the shutter](/docs-assets/attachments/zh/S-attachments-04-camera.png)
...
![The "the selected model does not accept images" prompt](/docs-assets/attachments/zh/S-attachments-05-model-no-images.png)
...
![The prompt that microphone or camera permission needs to be granted once in a regular tab](/docs-assets/attachments/zh/S-attachments-06-handoff.png)
