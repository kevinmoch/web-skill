...
![The four destinations of an artifact: view in the conversation, present in a new window (needs your consent), download locally, print to PDF](/docs-assets/artifacts/en/M-17.svg)
...
![The "Confirmation" card before a window opens, stating which skill wants to open it and where the data comes from](/docs-assets/artifacts/en/S-artifacts-02-open-confirm.png)
...
![A monitoring dashboard opened in a separate window](/docs-assets/artifacts/en/S-artifacts-03-screen-window.png)
...
![Slides being presented, with the page number in the bottom-left corner](/docs-assets/artifacts/en/S-artifacts-04-slides-presenting.png)
...
![The print preview of the slides, with layout and dark background preserved](/docs-assets/artifacts/en/S-artifacts-05-print-preview.png)
